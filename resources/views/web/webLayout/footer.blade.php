<footer class="bg-blue-950 py-12 text-white">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="mb-8 grid gap-8 md:grid-cols-4">
            <div>
                <div class="mb-4 flex items-center text-xl font-bold">

                    PhysicsFree
                </div>
                <p class="text-gray-400">
                    Empowering minds through expert physics education and personalized
                    tutoring.
                </p>
            </div>
            <div>
        ...
        <div class="border-t border-gray-800 pt-8 text-center text-gray-400">
            <p>&copy; 2025 PhysicsAce. All rights reserved.</p>
        </div>
    </div>
</footer>
